function [integral_hsv] = compute_feathsv_intgeral_c(img)
    %COMPUTE_FEATURE_INTGERAL 此处显示有关此函数的摘要
    %   此处显示详细说明
    hsv = rgb2hsv(img);
...
%     mex_compute_feathsv_integral(edges_1,edges_2,H,S,V);
    integral_hsv = mex_compute_feathsv_integral(edges_1,edges_2,H,S,V);
%     integral_hsv = 0;
